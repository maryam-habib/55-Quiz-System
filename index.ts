...
const quiz: {
    ...
    },
    {
        name: "question_3",
        type: "list",
        message: "Q3.Which operator is commonly used for string in Typescript?",
        choices: ["+", "-", "*", "/"]
    },
    {
        name: "question_4",
    ...
    },
    {
        name: "question_5",
        type: "list",
        message: "Q5.Which method of Inquirer.js is used to start the prompt interface and recevie user input?",
